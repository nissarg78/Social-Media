    ...
    return (
      ...
      <div className=" w-full  md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
        ...
        <div className="w-full h-100">
          ...
          <h1 className="text-xl font-bold">Welcome To Research Hub</h1>
          ...
          <form className="mt-6 " action="#" method="POST">
            ...
            {/* <button
            type="submit" className="bg-blue-500 w-full block hover:bg-blue-400 focus:bg-blue-400 text-white font-semibold rounded-lg
                  px-4 py-3 mt-6">Log In</button> */}
           <button
            type="submit"
            className="bg-blue-500 hover:bg-blue-400 w-full block text-white font-semibold rounded-lg px-4 py-3 mt-6"
            >
            Log In
          </button>
          ...
          {/* <button
          type='submit'
          className='bg-pink-600 w-full block text-white hover:bg-pink-400 font-semibold rounded-lg px-4 py-3 mt-6'
          >
            Try Login
          </button> */}
