...
export default function Register() {
    ...
    return (
      ...
      <div class="bg-blue-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
        <img src="bg2.jpg" alt="" class="w-full h-full object-cover"/>
      </div>
      ...
      <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
        ...
        <div class="w-full h-100">
          ...
          <h1 class="text-xl font-bold mt-5">Welcome To Research Hub</h1>
          <h1 class="text-xl md:text-2xl font-bold leading-tight mt-6">Create account</h1>
          ...
          <form class="mt-6" action="#" method="POST">
            ...
            <div class="mt-4">
              ...
              <input type="textbox" name="" id="" placeholder="Enter Your Name" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
                    focus:bg-white focus:outline-none" required/>
            </div>

            <div class="mt-4">
              <label class="block text-gray-700">Phone Number</label>
              <input type="textbox" name="" id="" placeholder="Enter Your Number" length="10" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
                    focus:bg-white focus:outline-none" required/>
            </div>
          ...
          <p class="mb-5">
           Already have an account? 
            <Link to= '/login' class="text-blue-500 hover:text-blue-700 font-semibold">
              Log In
            </Link>
          </p>
